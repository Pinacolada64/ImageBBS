...
; text editor stuff (from v2/visual.lbl):

flag1	= $03f3	; 1011
case1	= $03f4	; 1012
temp3	= $03f7	; 1015
mline	= $03f8	; 1016: kk, # of lines in text editor buffer at save (im: 1206, 1612)
comm	= $03f9	; 1017
; flags = $03fa	; 1018
...
videoram= $0400 ; 1024: start of sysop status line
light	= $04f0 ; 1264: lightbar screen ram start
var_0518= $0518 ; 1304: 1st line of sysop screen if mask on

; mci stuff:
mjump	= $07e8 ; 2024: Number of lines to skip for £J, £E, £D
...
; rs232 stuff:
carrst	= $07f1 ; 2033: carrier status
...
chk_right=$07f5 ; 2037: Checkmark flag for Lightbar (right side; Pinacolada added this)
readmode= $07f6 ; 2038: unabortable file read flag
filenum = $07f7	; 2039
tmp5	= $07f8	; 2040
abtchar	= $07f9	; 2041
clock	= $07fa	; 2042
...
bmpstart= $1001
mmpstart= $2001
lmpstart= $3001	; "little modem plus-file" start
...
scnmode	= $42f3 ; 17139: console: full (1) or screen mask (0) active
dflag	= $42f4
dstat	= $42f5
cytemp	= $42f6
interm	= $42f7
...
case	= $d001 ; 53249: uppercase lock flag (only for non-TurboREL systems): 1=all uppercase
editor	= $d002 ; 53250: flags for &,1
tsr	= $d003 ; 53251: time remaining for caller
llen	= $d004 ; 53252: Number of characters allowed for input.
		; Line length for &,1 and £Ix MCI command.
flag	= $d005 ; 53253: found from Image 2.0 source
chat	= $d006 ; 53254: flag for returning from and for an abort
inchat	= $d007 ; 53255: Presumably a flag set when you're in chat mode (found from Image 2.0 source)
chatpage= $d008 ; 53256: Turns on flashing page
access	= $d009 ; 53257: shadow for ac%
mxor	= $d00a ; 53258: Modem carrier invert XOR value: either 0 or 16, depending on modem type
mkolor	= $d00b ; 53259: MCI Kolorific mode flag
mupcase = $d00c	; 53260: MCI £Ux mode, 0=Mixed Case, 1=UPPERCASE ONLY [?]
irqcount= $d00d	; 53261
trans	= $d00e	; 53262
index	= $d00f	; 53263: Length of line returned from &,1 and £Ix MCI command
